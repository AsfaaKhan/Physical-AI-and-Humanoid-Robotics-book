"""
General helper functions for RAG pipeline utilities.
This file contains utility functions that were originally in src/utils.py
"""
...
def setup_logging(level: str = "INFO") -> logging.Logger:
    ...
    This is a duplicate of the function from the original utils.py file.
